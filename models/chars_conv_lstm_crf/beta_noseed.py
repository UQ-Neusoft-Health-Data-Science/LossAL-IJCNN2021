...
alpha_const=0.75
beta_const=0.5
output_dir="/home/s4616573/data/bert_ner_output/"+data_name+"_loss_alpha4_"+str(alpha_const)+"_beta1/"
...
log_file=output_dir+'results/'+data_name+'_alpha'+str(alpha_const)+"_"+str(uncertain_threshold)+'_betalossmax_'+str(beta_const)+'_'+str(seed_set_num)+'.txt'
handlers = [
