...
def crf_decode(potentials, transition_params, sequence_length):
  ...
  def _single_seq_fn():
    ...
    best_score_log=math_ops.reduce_max(tf.math.log1p( squeezed_potentials), axis=1)
    return math_ops.cast(decode_tags, dtype=dtypes.int32), potentials,best_score,squeezed_potentials
  ...
  def _multi_seq_fn():
    ...
    best_score_log = math_ops.reduce_max(tf.math.log1p(last_score), axis=1)  # [B]
    return decode_tags, potentials,best_score,last_score
